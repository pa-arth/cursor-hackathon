...
def main():
    ...
    from .cli_backend import add_model_arguments, apply_model_arguments

    parser = argparse.ArgumentParser(description="Loopback inspector for the browser agent.")
    add_model_arguments(parser)
    args = parser.parse_args()
    load_environment()
    backend = apply_model_arguments(args)
    print(f"Model: {args.model} ({backend})", flush=True)
